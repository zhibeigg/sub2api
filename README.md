...
- IDE model discovery uses the Connect-Protobuf `AiService/AvailableModels` RPC. Cloud Agent model discovery continues to use `GET /v1/models`, and API Key verification uses `GET /v1/me`.

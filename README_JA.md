...
- **内蔵決済システム** - EasyPay V1/V2、Alipay/WeChat Pay 直結、QQ Pay、Stripe に対応。WeChat Pay は Native/H5/JSAPI と `mp`/`wecom` OAuth を選択でき、署名済みコンテキストで元の決済インスタンスを固定し、WeCom 失敗時に H5 へ自動フォールバックしません（[設定ガイド](docs/PAYMENT.md)）

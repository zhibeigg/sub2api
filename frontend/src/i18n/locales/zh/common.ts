export default {
  ...
  auth: {
    welcomeBack: '登录账户',
    signInToAccount: '管理密钥、用量与账单。',
    signIn: '登录',
    signingIn: '登录中...',
    createAccount: '创建账户',
    signUpToStart: '创建账户后即可生成 API Key。',
    signUp: '注册',
    processing: '处理中...',
    continue: '继续',
    rememberMe: '记住我',
    ...
    brand: {
      ...
      titleLine1: '稳定接入',
      titleLine2: '不掺水',
      subtitle: '一个密钥接入主流模型，价格与用量始终可查。',
      loginChapter: '返回你的路由现场',
      loginTitleLine1: '继续调用',
      loginTitleLine2: '保持清醒',
      loginSubtitle: '登录后查看密钥、模型、用量与逐笔账单，继续沿用你的 SDK 与 CLI。',
      registerChapter: '建立新的接入节点',
      registerTitleLine1: '创建密钥',
      registerTitleLine2: '接入模型',
      registerSubtitle: '一个账户连接 Claude、OpenAI、Gemini 等主流模型，费用与状态始终可查。',
      orbitLabel: '账户与协议安全轨道',
      orbitStatus: '安全通道',
      formKicker: '账户入口',
      privacyTitle: '隐私原则',
      privacyNote: '不保存 API 请求内容，不出售用户数据，不用于广告或模型训练；仅处理服务运行所必需的数据。',
      factStable: '多通道路由',
      factTransparent: '透明按量计费',
      navHome: '首页',
      navDocs: '文档',
      skipToForm: '跳到账户表单'
    },

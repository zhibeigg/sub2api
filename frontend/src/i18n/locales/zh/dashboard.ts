export default {
  ...
  keys: {
    ...
    endpoints: {
      ...
      availableTitle: '可用端点',
      primaryName: '主线路',
      builtInName: 'PokeAPI 备用入口',
      builtInDescription: '兼容 PokeAPI 的备用访问域名，可在主线路网络不佳时切换使用。',
      defaultDescription: '管理员提供的 API 访问线路。',
      default: '默认',
      backup: '备用',
      copied: '已复制',
      copiedHint: '已复制到剪贴板',
      ...
      unreachable: '不可达',
      notTested: '尚未测速',
      testedSummary: '已完成 {tested}/{total}',
      nodeAddress: '节点地址',
      measuredLatency: '当前延迟',
      nodeStatus: '连接状态',
      lastTestedAt: '测速时间',
      statusTesting: '正在检测当前浏览器网络',
      statusTimeout: '连接超时',
      statusUnreachable: '当前网络无法访问',
      status: {
        fast: '响应迅速',
        normal: '连接正常',
        slow: '连接偏慢',
    ...
    clickToChangeGroups: '编辑有序分组绑定',
    editGroupBindings: '编辑分组绑定',
    selectedGroups: '已选择（{count}）',
    availableGroups: '可选分组',
    dragToPrioritize: '拖拽调整优先级',
    dragGroup: '拖拽“{name}”调整顺序',
    moveGroupUp: '上移“{name}”',
    moveGroupDown: '下移“{name}”',
    removeGroup: '移除“{name}”',
    allGroupsSelected: '已选择全部可用分组',
    unknownPlatform: '未知平台',
    saveAndContinue: '保存并继续编辑',
    groupBindingsSaved: '分组绑定已保存',
    failedToSaveGroupBindings: '保存分组绑定失败',
  ...
  usage: {
    ...
    fastBillingBadge: 'Fast 计费',
    fastBillingIncluded: '已含 Fast 加价',
    fastBillingTitle: 'Fast（priority）计费',
    fastBillingDescription: '当前原始费用和最终扣费均已包含 Fast 价格，不会再在账单外额外加扣。',
    rate: '倍率',
    original: '原始',
    billed: '计费',

export default {
    accounts: {
      ...
      cursor: {
        ...
        credentialsHint: '推荐通过本地浏览器扩展完成网页登录。扩展只在你主动操作后读取 cursor.com 的 _vcrcs Cookie，并复用当前后台的凭据验证流程。',
        cookie: 'Cursor Cookie',
        cookiePlaceholder: '粘贴包含 _vcrcs 的完整 Cookie',
        cookieRequired: '请使用 Cursor 网页登录，或手动输入包含 _vcrcs 的 Cookie。',
        cookieExpiresAt: 'Cookie 到期时间',
        cookieExpiresAtHint: '网页导入时会自动填写；会话 Cookie 可留空。',
        upstreamModel: 'Cursor 内部模型（可选）',
        upstreamModelPlaceholder: '留空使用模型映射或系统默认值',
        upstreamModelHint: '仅在你明确知道 Cursor 文档聊天接口所需内部模型时填写。此值会覆盖账号模型映射和系统默认值。',
        referer: 'Referer（可选）',
        refererPlaceholder: '留空使用系统默认值',
        refererHint: '普通部署无需修改。系统默认使用 https://cursor.com/docs。',
        manualImport: '手动导入 Cookie',
        manualImportHint: '仅作为扩展不可用时的兜底。Cookie 明文不会显示在页面文本中。',
        advancedSettings: '高级设置',
        browserLogin: {
          title: 'Cursor 网页登录',
          action: '使用 Cursor 网页登录并创建',
          downloadExtension: '下载登录助手',
          securityNote: '扩展不读取账号密码，不枚举其他 Cookie，不绕过验证码或 Vercel Challenge。凭据只返回当前发起操作的后台标签页。',
          extensionVersion: '登录助手版本 {version}',
          installTitle: '首次使用：安装 Cursor 登录助手',
          installStepDownload: '下载 ZIP 并解压到本地目录。',
          installStepExtensions: '在 Chrome 或 Edge 打开 chrome://extensions，并开启开发者模式。',
          installStepLoad: '选择“加载已解压的扩展程序”，打开刚才解压的目录。',
          installStepRefresh: '刷新 Sub2API 管理后台，然后重新进入 Cursor 创建流程。',
          status: {
            detecting: '正在检测浏览器扩展…',
            unavailable: '未检测到登录助手。安装后刷新页面，或使用下方手动导入。',
            ready: '登录助手已就绪。点击后将在新标签页打开 Cursor。',
            opening: '正在打开 Cursor 登录页…',
            waiting: '请在 Cursor 原站完成登录；完成后会自动读取所需 Cookie。最长等待 10 分钟。',
            reading: '已检测到登录状态，正在安全回填凭据…',
            received: '已获取凭据，准备验证。',
            verifying: '正在通过 Cursor 文档聊天接口验证凭据…',
            creating: '凭据有效，正在创建账号…'
          },
          errors: {
            notConfigured: '当前页面未连接登录助手。请安装扩展、授权当前后台站点并刷新页面。',
            busy: '已有 Cursor 登录流程正在进行，请先完成或关闭该流程。',
            cursorTabClosed: 'Cursor 登录页已关闭。请重新发起网页登录。',
            sourceTabGone: '发起登录的后台页面已关闭，凭据未被回填。',
            sourceDocumentChanged: '后台页面已刷新或跳转。请重新发起网页登录。',
            cookieNotFound: '登录完成后仍未找到 _vcrcs Cookie。请确认 Cursor 登录成功后重试。',
            timeout: 'Cursor 登录等待已超时。请重新发起网页登录。',
            cancelled: 'Cursor 登录已取消。',
            originNotAllowed: '登录助手尚未授权当前后台域名。请在扩展设置中授权后刷新页面。',
            unsupportedProtocol: '登录助手版本与当前后台不兼容。请下载并安装最新版本。',
            internal: '登录助手未能完成导入。请重试或使用手动 Cookie 导入。',
            invalidCredential: '登录助手返回的凭据格式无效，未写入账号表单。'
          }
        },
        editCredentialsTitle: '更新 Cursor 凭据',
        editCredentialsHint: 'Cookie 明文不会回填。默认保留，仅替换或明确清除时发送变更。',
        configured: '已配置',
        notConfigured: '未配置',
        keep: '保留',
        replace: '替换',
        clear: '清除',
        replacePlaceholder: '输入新的 Cookie',
        clearConfirm: '确认清除 Cursor Cookie？清除后账号将无法调度。',
        credentialValid: '凭据可用',

export default {
    accounts: {
      ...
      cursor: {
        credentialsTitle: 'Cursor Cookie 凭据',
        credentialsHint: '粘贴已有 Cookie，并可按需配置到期时间、上游模型和 Referer。',
        cookie: 'Cookie',
        cookiePlaceholder: '粘贴完整 Cookie',
        cookieRequired: '请输入 Cursor Cookie。',
        cookieExpiresAt: 'Cookie 到期时间',
        upstreamModel: '上游模型',
        upstreamModelPlaceholder: '例如 claude-sonnet-4-5',
        referer: 'Referer',
        refererPlaceholder: '例如 https://www.cursor.com/',

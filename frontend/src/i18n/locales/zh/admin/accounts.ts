export default {
    accounts: {
      ...
      cursor: {
        ...
        editCredentialsTitle: '更新 Cursor API Key',
        editCredentialsHint: 'API Key 明文不会回填。默认保留，仅替换或明确清除时发送变更。',
        configured: '已配置',
        notConfigured: '未配置',
        keep: '保留',
        replace: '替换',
        clear: '清除',
        replacePlaceholder: '输入新的 Cursor API Key',
        clearConfirm: '确认清除 Cursor API Key？清除后账号将无法调度。',

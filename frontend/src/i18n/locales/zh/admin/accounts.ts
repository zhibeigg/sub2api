export default {
    accounts: {
      ...
      adobe: {
        credentialsTitle: 'Adobe Firefly 凭据',
        sourceHint: '续期优先使用 Device Token + Device ID，失败后回退 Cookie；Access Token 可直接使用。',
        ...
        password: '恢复密码',
        passwordHint: '仅作为恢复/导入元数据保存，不会发送到 Firefly 或用于 IMS 续期。',
        expiresAt: 'Token 到期时间',
        devicePairRequired: 'Device Token 与 Device ID 必须同时填写。',
        sourceRequired: '至少填写 Access Token、完整 Device 凭据对或 Cookie。密码不能单独作为凭据来源。',
        editCredentialsTitle: '更新 Adobe 凭据',
        editCredentialsHint: '敏感值不会回填。默认保留；仅替换项和明确清除项会发送。',
        configured: '已配置', notConfigured: '未配置', action: '操作',
        keep: '保留', replace: '替换', clear: '清除',
        replacePlaceholder: '输入新值',
        devicePairClearHint: '清除任一 Device 字段会同时清除 Device Token 与 Device ID。',
        devicePairReplaceRequired: 'Device Token 与 Device ID 必须同时替换并填写。',
        clearConfirm: '确认清除以下敏感凭据：{fields}？此操作无法从界面恢复。',
        credits: 'Adobe Credits', creditsUnknown: '未知', creditsError: 'Credits 获取失败',
      ...
      cursor: {
        ...
        replace: '替换',
        clear: '清除',
        replacePlaceholder: '输入新凭据',
        clearConfirm: '确认清除以下 Cursor 敏感凭据：{fields}？请确保所选转发模式仍有可用凭据。',
        apiKeyConfigured: 'API Key 已配置',
        apiKeyNotConfigured: 'API Key 未配置',
        dashboardConnectionTitle: 'Cursor Dashboard',
        dashboardConnect: '一键连接',
        dashboardReconnect: '重新授权',
        dashboardConnecting: '正在连接…',
        dashboardCheckNow: '立即检测',
        dashboardChecking: '检测中…',
        dashboardDisconnect: '断开',
        dashboardUndoDisconnect: '撤销断开',
        dashboardDisconnectPending: '待断开',
        dashboardDisconnectPendingHint: 'Dashboard 凭据将在保存本次账号修改后清除。',
        dashboardStarting: '正在创建授权',
        dashboardStartingHint: '正在创建一次性授权会话，不会向前端返回 Token。',
        dashboardPending: '等待授权',
        dashboardPendingHint: '请在新窗口完成 Cursor 登录；此页面会自动轮询连接状态。',
        dashboardConnected: '已连接',
        dashboardConnectedHint: 'Dashboard 已独立授权，可读取官方套餐用量。Token 不会返回或存储在浏览器中。',
        dashboardConfiguredHint: '服务端已有 Dashboard 授权。可立即检测，或在授权失效时重新授权。',
        dashboardNotConnected: '未连接',
        dashboardNotConnectedHint: '一键连接会打开 Cursor 授权页，完成后由服务端保存凭据。',
        dashboardExpired: '已过期',
        dashboardExpiredHint: '本次授权会话已过期，请重新发起连接。',
        dashboardError: '授权异常',
        dashboardErrorHint: '未能确认 Dashboard 授权状态，请重试。',
        dashboardStartFailed: '无法创建 Cursor Dashboard 授权会话。',
        dashboardAuthConnected: 'Cursor Dashboard 已连接。',
        dashboardAuthExpiresAt: '本次授权会话截止：{time}',
        dashboardOpenAuthPage: '重新打开授权页面',
        dashboardPopupBlockedHint: '浏览器拦截了新窗口，请点击下方链接继续授权。',
        dashboardCheckSuccess: 'Cursor Dashboard 授权与官方用量检测成功。',
        dashboardCheckFailed: 'Cursor Dashboard 官方用量检测失败。',
        dashboardCheckMissing: '未检测到可用的 Cursor Dashboard 授权。',
        dashboardAdvancedFallback: '高级：手工 Token 回退',
        dashboardAdvancedFallbackHint: '仅在独立授权不可用时手工替换。敏感值不会回填，也不会保存在浏览器中。'
      },
      opencode: {
        accountType: 'OpenCode Go API Key',
        accountTypeHint: '通过 Zen Go 端点转发 OpenCode Go 的 Chat 与 Messages 模型目录。',
        baseUrlHint: '默认使用 https://opencode.ai/zen/go；仅在使用兼容中继时修改。',
        apiKeyHint: '必填转发 API Key。作为敏感凭据保存，创建后不会回填明文。',
        api_key: 'API Key',
        quota_cookie: '配额 Cookie',
        quotaCookie: '配额 Cookie（可选）',
        quotaCookiePlaceholder: '粘贴 OpenCode 配额 Cookie',
        quotaCookieHint: '仅用于查询官方配额窗口，属于敏感值，创建后不会回填。',
        quotaWorkspaceId: '配额 Workspace ID',
        quotaWorkspaceIdPlaceholder: 'workspace id（可选）',
        quotaWorkspaceIdHint: '与配额 Cookie 配合使用的可选工作区标识。',
        modelProtocols: '模型协议',
        modelProtocolsHint: '为每个模型指定 chat_completions 或 messages；其他协议值会被丢弃。',
        modelName: '模型名称',
        addModelProtocol: '添加模型协议',
        validationTitle: '真实推理预检',
        validationHint: '保存前会先读取模型目录，再发送一次最小真实推理请求；只有推理成功才会创建账户。',
        validationModel: '预检模型',
        validationModelAuto: '自动选择（优先 kimi-k3）',
        validationModelHint: '可显式选择要验证的模型；留空时按稳定优先级从上游可用目录中选择。',
        replacementValidationHint: '替换 Key 时会先执行真实推理预检；失败则不会提交更新，旧 Key 保持不变。',
        configured: '已配置',
        notConfigured: '未配置',
        keep: '保留',
        replace: '替换',
        clear: '清除',
        replacePlaceholder: '输入新的敏感值',
        replaceRequired: '请输入 {field} 的替换值。',
        clearConfirm: '确认清除以下 OpenCode Go 敏感凭据：{fields}？此操作无法从当前界面恢复。',
        rolling: '滚动',
        weekly: '每周',
        monthly: '每月',
      ...
      credentialsValidation: {
        ...
        openCodeStepTitle: 'OpenCode 真实推理预检',
      ...
      usageWindowsHint: '“5h / 7d”等进度条是上游账号的官方滚动用量窗口，并非 sub2api 配置。容量摘要会明确区分上游真实余额、上次快照、非权威窗口估算、不支持、未知或无限状态；“未知”不代表剩余为 0。',
      upstreamBilling: {
      ...
      usageWindow: {
        ...
        cursorOfficialUsage: 'Cursor 官方套餐',
        cursorFirstParty: '首方',
        cursorAPI: 'API',
        cursorDashboardMissing: '官方用量未配置',
        cursorDashboardStale: '官方用量刷新失败，显示上次快照',
        cursorDashboardError: '官方用量获取失败',
        cursorDashboardUpdatedAt: '官方用量更新于 {time}',
        cursorPlanSpend: '已用 ${used} / ${limit}',
        cursorNoActivePlan: '当前没有可用的 Cursor 套餐用量窗口',
        cursorLocalUsage: 'Sub2API 今日用量',
        capacity: {
          verifiedUpstream: '上游真实余额',
          verifiedLocal: '已验证本地配额',
          verified: '已验证容量',
          staleSnapshot: '上次容量快照',
          estimatedWindow: '非池窗口估算',
          unsupported: '容量查询不受支持',
          unknown: '容量未知',
          unlimited: '无限容量',
          modeUpstreamBalance: '上游余额',
          modeUsageWindow: '用量窗口',
          modeLocalQuota: '本地配额',
          authoritative: '权威数据',
          ...
          total: '总量',
          used: '已用',
          estimatedRequests: '约 {value} 次请求',
          averageCost: '均次 {value}',
          samples: '样本 {count} 次',
          updatedAt: '更新 {time}',
          resetAt: '重置 {time}',
          scope: '范围 {value}',
      ...
      oauth: {
        ...
        kiro: {
          title: 'Kiro 账号授权',
          method: '添加方式',
          methodBuilderID: 'AWS Builder ID（设备码）',
          methodIAMSSO: 'IAM Identity Center（企业 SSO）',
          methodSSOToken: 'SSO Token 导入',
          methodCredentials: '粘贴凭证 JSON',
          region: '区域',
          regionPlaceholder: '默认 us-east-1',
          startUrl: 'SSO 起始地址',
          startUrlPlaceholder: 'https://your-org.awsapps.com/start',
          builderIDStep: '点击开始后，在浏览器打开授权页并输入下方用户码。',
          startLogin: '开始登录',
          userCode: '用户码',
          openVerificationUri: '打开授权页面',
          waitingAuthorization: '等待授权中…',
          builderIDDone: '授权成功，正在创建账号…',
          iamSSOStep: '点击生成授权链接，完成授权后将浏览器地址栏的回调 URL 粘贴回来。',
          generateAuthUrl: '生成授权链接',
          openAuthUrl: '打开授权链接',
          callbackUrl: '回调 URL',
          callbackUrlPlaceholder: '粘贴完整回调 URL（含 ?code=...&state=...）',
          completeLogin: '完成登录',
          bearerToken: 'SSO Bearer Token',
          bearerTokenPlaceholder: '粘贴 x-amz-sso_authn bearer token',
          importToken: '导入并创建账号',
          credentialsJson: '凭证 JSON',
          credentialsPlaceholder: '粘贴从 Kiro-Go / Kiro IDE 导出的凭证 JSON',
          failedToStart: '启动 Kiro 登录失败',
          pollFailed: 'Kiro 授权轮询失败',
          missingCallback: '缺少回调 URL 或会话',
          failedToComplete: 'Kiro 授权完成失败',
          missingBearer: '请输入 SSO Bearer Token',
          failedToImport: 'Kiro SSO Token 导入失败'
        },
        // Gemini specific
        gemini: {
          title: 'Gemini 账户授权',

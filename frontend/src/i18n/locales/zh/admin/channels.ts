export default {
    ...
    riskControl: {
      ...
      cyberAbuseTitle: 'Cyber Abuse 防护',
      cyberAbuseDescription: '识别高风险网络滥用请求，并将本地检测与上游 cyber_policy 反馈统一纳入风控处置。',
      cyberAbuseEnabled: '启用防护',
      cyberAbuseDefaultOffNotice: '该功能默认关闭，需由管理员明确启用。',
      cyberAbuseHitBehaviorNotice: '命中规则后会向用户显示警告并终止当前请求。',
      cyberAbuseResearchContextNotice: '合法、获授权的安全研究可能需要在输入中明确说明授权范围和防御性上下文。',
      cyberAbuseLegalNotice: '检测结果仅用于风险控制，不替代法律判断或专业合规意见。',
      cyberAbuseLocalPrecheck: '本地前置检测',
      cyberAbuseLocalPrecheckHint: '请求发往上游前执行本地规则检测，命中时直接阻断。',
      cyberAbuseUpstreamFeedback: '联动上游 cyber_policy',
      cyberAbuseUpstreamFeedbackHint: '将上游 cyber_policy 反馈关联到 Cyber Abuse 规则与日志。',
      cyberAbuseCountAutoBan: '计入自动封号',
      cyberAbuseCountAutoBanHint: '命中后计入违规次数，并参与现有自动封号阈值判断。',
      cyberAbuseWarningMessage: '警告文案',
      cyberAbuseWarningMessagePlaceholder: '输入命中 Cyber Abuse 规则时展示给用户的警告内容',
      cyberAbuseWarningMessageHint: '该文案会在请求被阻断时返回给用户，请保持清晰并避免作出法律定性。',
      cyberAbuseDefaultWarningMessage: '该请求涉嫌恶意网络活动或违反上游使用政策，已终止执行。请仅提交合法、已授权且防御性的安全需求；重复触发可能导致 API Key 或账号暂停。',
      cyberAbuseTestTitle: 'Cyber Abuse 无副作用试跑',
      cyberAbuseTestHint: '仅评估输入并返回规则结果，不写入日志、不累计违规次数，也不会触发封号或通知。',
      cyberAbuseNoSideEffects: '无副作用',
      cyberAbuseTestPlaceholder: '输入需要评估的安全相关请求内容',
      cyberAbuseRunTest: '运行试跑',
      cyberAbuseTesting: '检测中',
      cyberAbuseTestFailed: 'Cyber Abuse 试跑失败',
      cyberAbuseTestResult: '试跑结果',
      cyberAbuseMatched: '命中',
      cyberAbuseNotMatched: '未命中',
      ...
      action: {
        block: '拦截',
        keywordBlock: '关键词拦截',
        cyberAbuseBlock: 'Cyber Abuse 阻断',
        cyberPolicy: '网络安全策略阻断',
        error: '异常',
      },
    },
    ...
    subscriptions: {
      ...
      planHint: '套餐决定订阅分组与共享额度，选择后可调整本次有效期。',

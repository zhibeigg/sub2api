export default {
  ...
  keys: {
    ...
    groupModels: '{count} available models',
    groupNoModels: 'No available models',
    multiGroupHint: 'Select multiple groups; they are tried by priority in the chosen order. Drag to reorder.',
    usage: 'Usage',
    today: 'Today',
    total: 'Last 30d',
    quota: 'Quota',
  ...
  admin: {
    ...
    groups: {
      ...
      failedToToggleStatus: 'Failed to toggle group status',

export default {
  ...
  auth: {
    welcomeBack: 'Sign In',
    signInToAccount: 'Manage your keys, usage, and billing.',
    signIn: 'Sign In',
    signingIn: 'Signing in...',
    createAccount: 'Create Your Account',
    signUpToStart: 'Create an account to issue your API key.',
    signUp: 'Sign up',
    processing: 'Processing...',
    continue: 'Continue',
    ...
    brand: {
      eyebrow: 'Stable · Genuine · Fair',
      titleLine1: 'Stable access.',
      titleLine2: 'No dilution.',
      subtitle: 'One key for leading models, with pricing and usage always visible.',
      loginChapter: 'Return to your routing desk',
      loginTitleLine1: 'Keep calling.',
      loginTitleLine2: 'Stay clear.',
      loginSubtitle: 'Review keys, models, usage, and itemized costs, then continue with the SDKs and CLIs you already use.',
      registerChapter: 'Create a new access node',
      registerTitleLine1: 'Create a key.',
      registerTitleLine2: 'Reach models.',
      registerSubtitle: 'One account connects Claude, OpenAI, Gemini, and more, with cost and request status always visible.',
      orbitLabel: 'Account and protocol security orbit',
      orbitStatus: 'Secure route',
      formKicker: 'Account Access',
      privacyTitle: 'Privacy Principle',
      privacyNote: 'API request content is not retained. We do not sell user data or use it for advertising or model training; only service-required data is processed.',
      factStable: 'Multi-channel routing',
      factTransparent: 'Clear usage-based billing',
      navHome: 'Home',
      navDocs: 'Docs',
      skipToForm: 'Skip to account form'
    },

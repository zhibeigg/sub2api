export default {
  ...
  payment: {
    ...
    admin: {
      ...
      summaryScopeHint: 'Scope: gross received includes successful recharge orders only; net recharge equals gross received minus refunds. All metrics follow the active filters.',

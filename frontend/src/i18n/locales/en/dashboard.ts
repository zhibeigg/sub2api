export default {
  ...
  keys: {
    ...
    endpoints: {
      title: 'API Endpoints',
      availableTitle: 'Available endpoints',
      primaryName: 'Primary route',
      builtInName: 'PokeAPI backup route',
      builtInDescription: 'A PokeAPI-compatible backup domain for switching when the primary route performs poorly.',
      defaultDescription: 'An API access route provided by the administrator.',
      default: 'Default',
      backup: 'Backup',
      copied: 'Copied',
      ...
      testedSummary: '{tested}/{total} tested',
      nodeAddress: 'Endpoint',
      measuredLatency: 'Latency',
      nodeStatus: 'Status',
      lastTestedAt: 'Tested at',
      statusTesting: 'Testing from this browser',
      statusTimeout: 'Connection timed out',
      statusUnreachable: 'Unavailable from the current network',
      status: {
        fast: 'Fast response',
        normal: 'Healthy connection',
        slow: 'Slower connection',
        poor: 'High latency',
    ...
    clickToChangeGroups: 'Edit ordered group bindings',
    editGroupBindings: 'Edit group bindings',
    selectedGroups: 'Selected ({count})',
    availableGroups: 'Available groups',
    dragToPrioritize: 'Drag to set priority',
    dragGroup: 'Drag {name} to reorder',
    moveGroupUp: 'Move {name} up',
    moveGroupDown: 'Move {name} down',
    removeGroup: 'Remove {name}',
    allGroupsSelected: 'All available groups are selected',
    unknownPlatform: 'Unknown platform',
    saveAndContinue: 'Save and keep editing',
    groupBindingsSaved: 'Group bindings saved',
    failedToSaveGroupBindings: 'Failed to save group bindings',
  ...
  usage: {
    ...
    cacheCreationTokensLabel: 'Cache Write',
    ...
    fastBillingBadge: 'Fast billing',
    fastBillingIncluded: 'Fast price included',
    fastBillingTitle: 'Fast (priority) billing',
    fastBillingDescription: 'Both the original cost and final charge already include the Fast price. No additional Fast surcharge is added outside the bill.',
    rate: 'Rate',
    original: 'Original',
    billed: 'Billed',

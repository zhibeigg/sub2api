export default {
    accounts: {
      ...
      cursor: {
        ...
        editCredentialsTitle: 'Update Cursor API Key',
        editCredentialsHint: 'The API Key is never prefilled. Keep is the default; only replacements and explicit clears are sent.',
        configured: 'Configured',
        notConfigured: 'Not configured',
        keep: 'Keep',
        replace: 'Replace',
        clear: 'Clear',
        replacePlaceholder: 'Enter a new Cursor API Key',
        clearConfirm: 'Clear the Cursor API Key? The account will no longer be schedulable.',

export default {
    accounts: {
      ...
      cursor: {
        ...
        credentialsHint: 'Use the local browser extension for the recommended web login flow. It reads only the cursor.com _vcrcs Cookie after an explicit action and reuses this admin page’s credential validation flow.',
        cookie: 'Cursor Cookie',
        cookiePlaceholder: 'Paste a complete Cookie containing _vcrcs',
        cookieRequired: 'Use Cursor web login or enter a Cookie containing _vcrcs.',
        cookieExpiresAt: 'Cookie Expiry',
        cookieExpiresAtHint: 'Filled automatically by browser import. Leave empty for a session Cookie.',
        upstreamModel: 'Cursor Internal Model (Optional)',
        upstreamModelPlaceholder: 'Leave empty to use model mapping or the system default',
        upstreamModelHint: 'Only set this when you know the internal model required by Cursor Docs chat. It overrides account model mapping and the system default.',
        referer: 'Referer (Optional)',
        refererPlaceholder: 'Leave empty to use the system default',
        refererHint: 'Most deployments should leave this empty. The system default is https://cursor.com/docs.',
        manualImport: 'Manually Import Cookie',
        manualImportHint: 'Use this only when the extension is unavailable. The Cookie value is never rendered as page text.',
        advancedSettings: 'Advanced Settings',
        browserLogin: {
          title: 'Cursor Web Login',
          action: 'Log in to Cursor and Create',
          downloadExtension: 'Download Login Helper',
          securityNote: 'The extension does not read passwords, enumerate other Cookies, or bypass CAPTCHA or Vercel Challenge. Credentials return only to the admin tab that started the flow.',
          extensionVersion: 'Login helper version {version}',
          installTitle: 'First use: install the Cursor login helper',
          installStepDownload: 'Download the ZIP and extract it to a local folder.',
          installStepExtensions: 'Open chrome://extensions in Chrome or Edge and enable Developer mode.',
          installStepLoad: 'Choose “Load unpacked” and select the extracted folder.',
          installStepRefresh: 'Refresh the Sub2API admin page and reopen the Cursor creation flow.',
          status: {
            detecting: 'Detecting the browser extension…',
            unavailable: 'The login helper was not detected. Install it and refresh, or use manual import below.',
            ready: 'The login helper is ready. Cursor will open in a new tab.',
            opening: 'Opening the Cursor login page…',
            waiting: 'Complete login on Cursor. The required Cookie will be detected automatically. The flow waits up to 10 minutes.',
            reading: 'Login detected. Securely returning the credential…',
            received: 'Credential received and ready for validation.',
            verifying: 'Validating the credential through Cursor Docs chat…',
            creating: 'Credential validated. Creating the account…'
          },
          errors: {
            notConfigured: 'This page is not connected to the login helper. Install the extension, authorize this admin origin, and refresh.',
            busy: 'Another Cursor login flow is active. Complete or close it before trying again.',
            cursorTabClosed: 'The Cursor login tab was closed. Start the web login again.',
            sourceTabGone: 'The admin tab that started login was closed, so no credential was returned.',
            sourceDocumentChanged: 'The admin page was refreshed or navigated. Start the web login again.',
            cookieNotFound: 'The _vcrcs Cookie was not found after login. Confirm that Cursor login completed and try again.',
            timeout: 'Cursor login timed out. Start the web login again.',
            cancelled: 'Cursor login was cancelled.',
            originNotAllowed: 'The login helper has not authorized this admin origin. Authorize it in extension settings and refresh.',
            unsupportedProtocol: 'The login helper is incompatible with this admin version. Install the latest extension.',
            internal: 'The login helper could not complete the import. Try again or use manual Cookie import.',
            invalidCredential: 'The login helper returned an invalid credential format. Nothing was written to the account form.'
          }
        },
        editCredentialsTitle: 'Update Cursor Credentials',
        editCredentialsHint: 'The Cookie value is never prefilled. Keep is the default; only replacements and explicit clears are sent.',
        configured: 'Configured',
        notConfigured: 'Not configured',
        keep: 'Keep',
        replace: 'Replace',
        clear: 'Clear',
        replacePlaceholder: 'Enter a new Cookie',
        clearConfirm: 'Clear the Cursor Cookie? The account will no longer be schedulable.',
        credentialValid: 'Credentials available',

export default {
    accounts: {
      ...
      cursor: {
        credentialsTitle: 'Cursor Cookie Credentials',
        credentialsHint: 'Paste an existing Cookie and optionally configure its expiry, upstream model, and Referer.',
        cookie: 'Cookie',
        cookiePlaceholder: 'Paste the complete Cookie',
        cookieRequired: 'Enter a Cursor Cookie.',
        cookieExpiresAt: 'Cookie Expiry',
        upstreamModel: 'Upstream Model',
        upstreamModelPlaceholder: 'e.g. claude-sonnet-4-5',
        referer: 'Referer',
        refererPlaceholder: 'e.g. https://www.cursor.com/',

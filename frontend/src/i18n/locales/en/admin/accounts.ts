export default {
    accounts: {
      ...
      adobe: {
        credentialsTitle: 'Adobe Firefly Credentials',
        sourceHint: 'Refresh prefers Device Token + Device ID, then falls back to Cookie. An Access Token can be used directly.',
        accessToken: 'Access Token', access_token: 'Access Token',
        cookie: 'Cookie',
        deviceToken: 'Device Token', device_token: 'Device Token',
        deviceId: 'Device ID', device_id: 'Device ID',
        password: 'Recovery Password',
        passwordHint: 'Stored only as recovery/import metadata. It is never sent to Firefly or used for IMS refresh.',
        expiresAt: 'Token Expiry',
        devicePairRequired: 'Device Token and Device ID must be provided together.',
        sourceRequired: 'Provide an Access Token, a complete device pair, or a Cookie. Password alone is not a usable source.',
        editCredentialsTitle: 'Update Adobe Credentials',
        editCredentialsHint: 'Secrets are never prefilled. Keep is the default; only replacements and explicit clears are sent.',
        configured: 'Configured', notConfigured: 'Not configured', action: 'Action',
        keep: 'Keep', replace: 'Replace', clear: 'Clear',
        replacePlaceholder: 'Enter a new value',
        devicePairClearHint: 'Clearing either device field clears both Device Token and Device ID.',
        devicePairReplaceRequired: 'Device Token and Device ID must be replaced together.',
        clearConfirm: 'Clear these sensitive credentials: {fields}? They cannot be recovered from this screen.',
        credits: 'Adobe Credits', creditsUnknown: 'Unknown', creditsError: 'Failed to load credits',
      ...
      cursor: {
        ...
        replace: 'Replace',
        clear: 'Clear',
        replacePlaceholder: 'Enter a new credential',
        clearConfirm: 'Clear these Cursor credentials: {fields}? Make sure the selected forwarding mode still has usable credentials.',
        apiKeyConfigured: 'API Key configured',
        apiKeyNotConfigured: 'API Key not configured',
        dashboardConnectionTitle: 'Cursor Dashboard',
        dashboardConnect: 'Connect',
        dashboardReconnect: 'Reauthorize',
        dashboardConnecting: 'Connecting…',
        dashboardCheckNow: 'Check now',
        dashboardChecking: 'Checking…',
        dashboardDisconnect: 'Disconnect',
        dashboardUndoDisconnect: 'Undo disconnect',
        dashboardDisconnectPending: 'Pending disconnect',
        dashboardDisconnectPendingHint: 'Dashboard credentials will be cleared when you save this account update.',
        dashboardStarting: 'Starting authorization',
        dashboardStartingHint: 'Creating a one-time authorization session. No token is returned to the frontend.',
        dashboardPending: 'Waiting for authorization',
        dashboardPendingHint: 'Complete Cursor sign-in in the new window. This page will poll the connection status automatically.',
        dashboardConnected: 'Connected',
        dashboardConnectedHint: 'Dashboard is independently authorized for official plan usage. Tokens are never returned to or stored by the browser.',
        dashboardConfiguredHint: 'Dashboard authorization exists on the server. Check it now, or reauthorize if it has expired.',
        dashboardNotConnected: 'Not connected',
        dashboardNotConnectedHint: 'Connect opens Cursor authorization and stores the resulting credentials on the server.',
        dashboardExpired: 'Expired',
        dashboardExpiredHint: 'This authorization session expired. Start a new connection.',
        dashboardError: 'Authorization error',
        dashboardErrorHint: 'The Dashboard authorization status could not be confirmed. Try again.',
        dashboardStartFailed: 'Could not start Cursor Dashboard authorization.',
        dashboardAuthConnected: 'Cursor Dashboard connected.',
        dashboardAuthExpiresAt: 'Authorization session expires: {time}',
        dashboardOpenAuthPage: 'Open authorization page again',
        dashboardPopupBlockedHint: 'The browser blocked the new window. Use the link below to continue authorization.',
        dashboardCheckSuccess: 'Cursor Dashboard authorization and official usage check succeeded.',
        dashboardCheckFailed: 'Cursor Dashboard official usage check failed.',
        dashboardCheckMissing: 'No usable Cursor Dashboard authorization was detected.',
        dashboardAdvancedFallback: 'Advanced: manual token fallback',
        dashboardAdvancedFallbackHint: 'Replace tokens manually only when standalone authorization is unavailable. Secrets are never prefilled or stored by the browser.'
      },
      opencode: {
        accountType: 'OpenCode Go API Key',
        accountTypeHint: 'Forwards the OpenCode Go Chat and Messages model catalogs through the Zen Go endpoint.',
        baseUrlHint: 'Default: https://opencode.ai/zen/go. Change it only when using a compatible relay.',
        apiKeyHint: 'Required forwarding API key. It is stored as a sensitive credential and is never prefilled after creation.',
        api_key: 'API Key',
        quota_cookie: 'Quota Cookie',
        quotaCookie: 'Quota Cookie (optional)',
        quotaCookiePlaceholder: 'Paste the OpenCode quota cookie',
        quotaCookieHint: 'Used only to query official quota windows. This sensitive value is never prefilled.',
        quotaWorkspaceId: 'Quota Workspace ID',
        quotaWorkspaceIdPlaceholder: 'workspace id (optional)',
        quotaWorkspaceIdHint: 'Optional workspace selector used together with the quota cookie.',
        modelProtocols: 'Model Protocols',
        modelProtocolsHint: 'Assign each model to chat_completions or messages. Other protocol values are discarded.',
        modelName: 'Model name',
        addModelProtocol: 'Add model protocol',
        validationTitle: 'Inference preflight',
        validationHint: 'Before saving, Sub2API reads the model catalog and sends a minimal real inference request. The account is created only after inference succeeds.',
        validationModel: 'Preflight model',
        validationModelAuto: 'Automatic (prefer kimi-k3)',
        validationModelHint: 'Choose a model explicitly, or leave this automatic to select a stable model from the upstream catalog.',
        replacementValidationHint: 'Replacing the API key runs a real inference preflight first. If it fails, no update is sent and the existing key remains active.',
        configured: 'Configured',
        notConfigured: 'Not configured',
        keep: 'Keep',
        replace: 'Replace',
        clear: 'Clear',
        replacePlaceholder: 'Enter a new sensitive value',
        replaceRequired: 'Enter a replacement value for {field}.',
        clearConfirm: 'Clear these OpenCode Go credentials: {fields}? This cannot be undone from this screen.',
        rolling: 'Rolling',
        weekly: 'Weekly',
        monthly: 'Monthly',
      ...
      credentialsValidation: {
        ...
        openCodeStepTitle: 'OpenCode Inference Preflight',
      ...
      openAIPlan: 'OpenAI Plan',
      allOpenAIPlans: 'All OpenAI Plans',
      planTypeUnset: 'Unset',
      allTypes: 'All Types',
      ...
      usageWindowsHint: 'Progress bars such as "5h / 7d" are official upstream rolling usage windows, not limits configured by sub2api. The capacity summary explicitly distinguishes verified upstream balance, the last stale snapshot, a non-authoritative window estimate, unsupported, unknown, and unlimited states. "Unknown" does not mean zero remaining.',
      ollamaCloud: {
      ...
      oauth: {
        ...
        kiro: {
          ...
          method: 'Add method',
          methodBuilderID: 'AWS Builder ID (device code)',
          methodIAMSSO: 'IAM Identity Center (enterprise SSO)',
          methodSSOToken: 'SSO token import',
          methodCredentials: 'Paste credentials JSON',
          region: 'Region',
          regionPlaceholder: 'Default us-east-1',
          startUrl: 'SSO start URL',
          startUrlPlaceholder: 'https://your-org.awsapps.com/start',
          builderIDStep: 'After starting, open the authorization page in your browser and enter the user code below.',
          startLogin: 'Start login',
          userCode: 'User code',
          openVerificationUri: 'Open authorization page',
          waitingAuthorization: 'Waiting for authorization…',
          builderIDDone: 'Authorized, creating account…',
          iamSSOStep: 'Generate the authorization URL, complete authorization, then paste the browser callback URL back here.',
          generateAuthUrl: 'Generate auth URL',
          openAuthUrl: 'Open auth URL',
          callbackUrl: 'Callback URL',
          callbackUrlPlaceholder: 'Paste the full callback URL (with ?code=...&state=...)',
          completeLogin: 'Complete login',
          bearerToken: 'SSO Bearer token',
          bearerTokenPlaceholder: 'Paste the x-amz-sso_authn bearer token',
          importToken: 'Import and create account',
          credentialsJson: 'Credentials JSON',
          credentialsPlaceholder: 'Paste credentials JSON exported from Kiro-Go / Kiro IDE',
          failedToStart: 'Failed to start Kiro login',
          pollFailed: 'Kiro authorization polling failed',
          missingCallback: 'Missing callback URL or session',
          failedToComplete: 'Failed to complete Kiro authorization',
          missingBearer: 'Please enter the SSO Bearer token',
          failedToImport: 'Kiro SSO token import failed'
        },
        // Gemini specific
	        gemini: {
      ...
      usageWindow: {
        ...
        cursorOfficialUsage: 'Cursor official plan',
        cursorFirstParty: '1st',
        cursorAPI: 'API',
        cursorDashboardMissing: 'Official usage not configured',
        cursorDashboardStale: 'Official usage refresh failed; showing the last snapshot',
        cursorDashboardError: 'Failed to load official usage',
        cursorDashboardUpdatedAt: 'Official usage updated {time}',
        cursorPlanSpend: '${used} / ${limit} used',
        cursorNoActivePlan: 'No active Cursor plan usage window',
        cursorLocalUsage: 'Sub2API usage today',
        capacity: {
          verifiedUpstream: 'Verified upstream balance',
          verifiedLocal: 'Verified local quota',
          verified: 'Verified capacity',
          staleSnapshot: 'Last capacity snapshot',
          estimatedWindow: 'Non-pool window estimate',
          unsupported: 'Capacity query unsupported',
          unknown: 'Capacity unknown',
          unlimited: 'Unlimited capacity',
          modeUpstreamBalance: 'Upstream balance',
          modeUsageWindow: 'Usage window',
          modeLocalQuota: 'Local quota',
          authoritative: 'Authoritative',
          nonAuthoritative: 'Non-authoritative',
          remaining: 'Remaining',
          total: 'Total',
          used: 'Used',
          estimatedRequests: '~{value} requests',
          averageCost: 'Avg {value}/request',

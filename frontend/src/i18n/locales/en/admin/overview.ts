export default {
    ...
    users: {
      ...
      groupConfigHint: 'The access allowlist, exclusive grants, and custom rates are independent. The latest configuration is loaded every time.',
      accessMode: 'Standard Group Access Mode',
      accessModeInherit: 'Inherit Standard Groups',
      accessModeInheritHint: 'Keeps existing behavior and automatically allows current and future standard groups. Switch to restricted mode to edit the allowlist.',
      accessModeRestricted: 'Restricted Mode',
      accessModeRestrictedHint: 'Only whitelisted standard groups are allowed. Exclusive groups also require a separate grant.',
      restrictedModeActive: 'A standard-group allowlist is active. Future standard groups will not be allowed automatically.',
      allowAllAndInherit: 'Allow All and Remove Restriction',
      searchGroupsPlaceholder: 'Search by name or platform',
      selectCurrentResults: 'Select Current Results',
      clearCurrentResults: 'Clear Current Results',
      groupSelectionStatus: '{selected}/{total} groups allowed, {visible} currently shown',
      emptyWhitelistWarning: 'The whitelist is empty. Saving will prevent this user from using any active standard group.',
      noMatchingGroups: 'No matching groups',
      exclusiveGroups: 'Exclusive Groups',
      publicGroups: 'Public Groups',
      publicGroupLabel: 'Public',
      defaultRate: 'Default Rate',
      customRate: 'Custom Rate',
      useDefaultRate: 'Use Default',
      customRatePlaceholder: 'Leave empty for default',
      customRateAria: 'Set a custom rate for group {group}',
      groupPermissionAria: 'Allow access to group {group}',
      exclusiveGrant: 'Exclusive Grant',
      exclusiveGrantAria: 'Grant access to exclusive group {group}',
      disabledGroupRatePreserved: 'Editing is unavailable, but the saved rate is preserved and applies again after access or the exclusive grant is restored.',
      invalidCustomRate: '{count} custom rate(s) are invalid. Enter a number greater than 0 or clear the field.',
      confirmGroupConfigTitle: 'Confirm Group Configuration',
      confirmGroupConfigMessage: 'Save in “{mode}” mode with {selected}/{total} current groups allowed?',
      groupConfigLoadFailed: 'Failed to load the user group configuration',
      groupConfigSaveFailed: 'Failed to save the user group configuration',
    ...
    groups: {
      ...
      failedToToggleStatus: 'Failed to update group status',

    ...
    settings: {
      ...
      site: {
        ...
        chatwoot: {
          ...
          description: 'Connect the Chatwoot Website Widget for anonymous visitors and verified signed-in users.',
          enabled: 'Enabled',
          disabled: 'Disabled',
          baseUrl: 'Chatwoot Base URL',
          baseUrlPlaceholder: 'https://app.chatwoot.com',
          baseUrlHint: 'Chatwoot Cloud or self-hosted instance URL. A trailing slash is removed on save.',
          websiteToken: 'Website Token',
          websiteTokenPlaceholder: 'Inbox Website Token',
          websiteTokenHint: 'This is the public widget identifier required by the browser, not an API Access Token.',
          identitySecret: 'Identity Validation Secret',
          identitySecretPlaceholder: 'Optional: enables HMAC identity validation',
          identitySecretConfiguredPlaceholder: 'Secret configured. Leave empty to keep it.',
          identitySecretHint: 'Without it, signed-in users remain anonymous and the frontend does not perform an untrusted identity binding.',
          identitySecretConfiguredHint: 'Server-side identity signing is configured. Leave this empty to retain the current secret.',
          identityConfigured: 'Identity verified',
          identityAnonymous: 'Anonymous mode',
          securityTitle: 'Security boundary',
          securityHint: 'The Identity Validation Secret stays server-side. The frontend receives only a stable identifier and HMAC identifier_hash. Use HTTPS in production and point the Base URL only at a trusted Chatwoot instance.',
          incompleteError: 'Enter a valid Base URL and Website Token before enabling Chatwoot.',
          invalidBaseUrlError: 'Chatwoot Base URL must be a valid http(s) URL.',
        },
        customEndpoints: {
      ...
      payment: {
        ...
        balancePaymentDisabledHint: 'Hide balance recharge on the purchase page without affecting subscriptions.',
        subscriptionPaymentDisabled: 'Disable Subscription Purchases',
        subscriptionPaymentDisabledHint: 'Hide subscription plans on the purchase page without affecting balance recharge.',
        ...
        validationWxpayH5AppUrl: 'H5 App URL must be an absolute HTTPS URL',
        validationWxpayMpAppId: 'Official Account JSAPI requires a wx-prefixed AppID. If the base App ID is a WeCom CorpID, enter an Official Account AppID or select WeCom authentication.',
        validationWxpayWecomCorpId: 'WeCom JSAPI authentication requires a ww-prefixed CorpID in the base App ID field.',
        validationWxpayWecomAgentId: 'When provided, the WeCom app AgentId must be a positive integer.',
        ...
        validationEasyPayCustomMethodReserved: 'Custom EasyPay payment types cannot use a method built into the selected protocol',
        ...
        field_mpAppId: 'Official Account AppID',
        field_wecomAppSecret: 'WeCom App Secret',
        field_wecomAgentId: 'WeCom App AgentId',
        ...
        field_mpAppIdHint: 'Used for Official Account authentication. Leave empty to reuse the base App ID; when the base App ID is a ww-prefixed WeCom CorpID, enter a wx-prefixed Official Account AppID.',
        field_wecomAppSecretHint: 'Secret of the WeCom custom app. This is sensitive; leaving it blank while editing preserves the stored value.',
        field_wecomAgentIdHint: 'Optional positive-integer AgentId of the WeCom custom app. The backend and WeCom APIs remain authoritative for validity.',
        ...
        wxpayNativeEnabledHint: 'Used for desktop QR codes and as a safe fallback on mobile or inside WeChat.',
        wxpayH5Enabled: 'H5 payment',
        wxpayH5EnabledHint: 'Used by mobile browsers outside WeChat. This independent switch defaults to off; enabling it requires H5 application details.',
        wxpayJsapiEnabled: 'JSAPI payment',
        wxpayJsapiEnabledHint: 'Used for authorization inside WeChat or WeCom; select the matching authentication type after enabling it.',
        wxpayJsapiAuthType: 'JSAPI authentication type',
        wxpayJsapiAuthTypeHint: 'Official Accounts and WeCom use different credentials and console settings. Historical configurations without this field load as Official Account mode and are never changed automatically from the CorpID.',
        wxpayJsapiAuthMp: 'WeChat Official Account',
        wxpayJsapiAuthWecom: 'WeCom custom app',
        wxpayWecomSuggested: 'The base App ID is a ww-prefixed WeCom CorpID. Select “WeCom custom app” when payments originate inside a WeCom app.',
        wxpayWecomSetupTitle: 'WeCom JSAPI configuration checklist',
        wxpayWecomTrustedDomainHint: 'Configure the trusted domain for the WeCom app and ensure this site passes the enterprise trusted-domain verification.',
        wxpayWecomCallbackHint: 'Register this site’s callback domain/address in the WeCom web authorization and JS-SDK settings, matching the actual protocol and host.',
        wxpayWecomVisibilityHint: 'Include every member or department that needs to pay in the custom app visibility scope, or those users may be unable to authorize the app.',
        wxpayWecomPaymentDirectoryHint: 'Configure the payment authorization directory in WeChat Pay Merchant Platform so it covers the HTTPS pages that start JSAPI payment.',
        wxpayConfigHint: 'Select the merchant capabilities already enabled, then fill the configuration required by those scenarios.',
        ...
        wxpayGuideSummary: 'Routes by enabled instance capability: desktop Native, H5 first on mobile outside WeChat, and JSAPI after obtaining a user identity inside WeChat or WeCom.',
        wxpayGuideNote: 'Enable only capabilities authorized in WeChat Pay Merchant Platform. H5 and JSAPI are independent switches, and disabled modes are blocked locally.',
        ...
        wxpayGuideNativeFallback: 'Mobile can safely fall back here before any WeChat API call when H5 is disabled, the client IP is missing, or in-WeChat JSAPI is disabled.',
        wxpayGuideJsapiTitle: 'JSAPI / Official Account or WeCom',
        wxpayGuideJsapiOpen: 'Official Account mode requires Official Account payment and an OpenID. WeCom mode requires custom-app credentials, trusted domain, callback, visibility scope, and payment authorization directory.',
        wxpayGuideJsapiCall: 'Inside WeChat or WeCom, authorize with the selected authentication type and then call JSAPI to launch WeChat Pay.',
        wxpayGuideJsapiFallback: 'When JSAPI is disabled, authorization is not started and QR fallback is allowed. The frontend flags clear credential combinations, while the backend and WeChat APIs remain authoritative.',
        ...
        wxpayGuideH5Fallback: 'When H5 is disabled or the client IP is missing, selection falls back locally to QR. H5 authorization or configuration errors are reported without calling another WeChat mode.',

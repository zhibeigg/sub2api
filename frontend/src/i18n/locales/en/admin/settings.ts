export default {
    settings: {
      ...
      payment: {
        ...
        wxpayH5EnabledHint: 'Used by mobile browsers outside WeChat; enabling it requires H5 application details.',
        wxpayJsapiEnabled: 'JSAPI Official Account payment',
        wxpayJsapiEnabledHint: 'Enable only after Official Account payment and OAuth credentials are configured.',
        ...
        wxpayGuideSummary: 'Routes by enabled instance capability: desktop Native, H5 first on mobile outside WeChat, and JSAPI only when an OpenID is present.',
        wxpayGuideNote: 'Enable only capabilities authorized in WeChat Pay Merchant Platform. Disabled modes are blocked locally and their WeChat APIs are not called.',
        ...
        wxpayGuideJsapiFallback: 'When JSAPI capability is disabled, OAuth is not started and QR fallback is allowed. Once JSAPI begins, authorization or API failures are reported structurally without blindly retrying another mode.',

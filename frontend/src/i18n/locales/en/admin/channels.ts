export default {
    ...
    riskControl: {
      ...
      cyberAbuseTitle: 'Cyber Abuse Protection',
      cyberAbuseDescription: 'Detect high-risk cyber-abuse requests and unify local checks with upstream cyber_policy feedback in risk-control actions.',
      cyberAbuseEnabled: 'Enable protection',
      cyberAbuseDefaultOffNotice: 'This feature is off by default and must be explicitly enabled by an administrator.',
      cyberAbuseHitBehaviorNotice: 'A matched rule warns the user and terminates the current request.',
      cyberAbuseResearchContextNotice: 'Legitimate, authorized security research may need explicit authorization scope and defensive context in the input.',
      cyberAbuseLegalNotice: 'Detection results support risk control and do not replace legal judgment or professional compliance advice.',
      cyberAbuseLocalPrecheck: 'Local pre-check',
      cyberAbuseLocalPrecheckHint: 'Run local rules before forwarding upstream and block the request immediately on a match.',
      cyberAbuseUpstreamFeedback: 'Link upstream cyber_policy',
      cyberAbuseUpstreamFeedbackHint: 'Associate upstream cyber_policy feedback with Cyber Abuse rules and audit logs.',
      cyberAbuseCountAutoBan: 'Count toward auto-ban',
      cyberAbuseCountAutoBanHint: 'Count matches as violations and include them in the existing auto-ban threshold.',
      cyberAbuseWarningMessage: 'Warning message',
      cyberAbuseWarningMessagePlaceholder: 'Enter the warning shown when a Cyber Abuse rule matches',
      cyberAbuseWarningMessageHint: 'This message is returned when a request is blocked. Keep it clear and avoid making legal determinations.',
      cyberAbuseDefaultWarningMessage: 'This request may involve malicious cyber activity or violate upstream usage policies, so execution was terminated. Submit only lawful, authorized, defensive security requests; repeated matches may suspend the API key or account.',
      cyberAbuseTestTitle: 'Side-effect-free Cyber Abuse test',
      cyberAbuseTestHint: 'Evaluates input and returns rule details without writing logs, counting violations, banning users, or sending notices.',
      cyberAbuseNoSideEffects: 'No side effects',
      cyberAbuseTestPlaceholder: 'Enter security-related request content to evaluate',
      cyberAbuseRunTest: 'Run test',
      cyberAbuseTesting: 'Checking',
      cyberAbuseTestFailed: 'Cyber Abuse test failed',
      cyberAbuseTestResult: 'Test result',
      cyberAbuseMatched: 'Matched',
      cyberAbuseNotMatched: 'Not matched',
      cyberAbuseResultMatched: 'matched',
      cyberAbuseResultCategory: 'category',
      cyberAbuseResultRuleId: 'rule_id',
      cyberAbuseResultConfidence: 'confidence',
      cyberAbuseResultErrorCode: 'error_code',
      cyberAbuseResultMessage: 'message',
      policySource: 'Policy source',
      policyRuleId: 'Policy rule ID',
      ...
      action: {
        ...
        cyberAbuseBlock: 'Cyber Abuse blocked',

export default {
    ...
    announcements: {
      ...
      email: {
        sendTitle: 'Announcement Email Delivery',
        sendDescription: 'This is a high-cost outbound action. It is off by default and is available only when the final status is Active and no email job exists.',
        sendToggle: 'Send email as well',
        loadingCapability: 'Checking email capability and estimated recipients…',
        estimatedRecipients: 'Estimated queue: {count} users with a valid primary email',
        primaryEmailOnly: 'Uses only each user’s current valid primary email; recipient addresses are never displayed or exported here.',
        ignoresTargeting: 'Email recipients are not restricted by the announcement targeting rules.',
        scheduledAtStarts: 'A start time is set; the email job becomes available at starts_at.',
        startsImmediately: 'No start time is set; the email job is queued immediately after publishing.',
        onceOnly: 'Each announcement creates at most one email job; later edits do not resend automatically.',
        featureDisabled: 'Announcement email delivery is disabled. Enable it in system email settings before retrying.',
        smtpNotConfigured: 'SMTP is not configured. Configure and verify the outbound mail server first.',
        activeOnly: 'Set the final announcement status to Active. Draft and archived announcements cannot send email.',
        alreadyQueued: 'This announcement already has an email job. Editing will not resend it; use the email status details to inspect or retry.',
        unavailable: 'Email cannot be sent for this announcement. Check the announcement status and email configuration.',
        failedToLoadCapability: 'Could not check announcement email capability. Refresh the page; if it persists, inspect the email service.',
        publishAndQueue: 'Publish and Send Email',
        confirmTitle: 'Confirm Publish and Email',
        confirmMessage: 'This will create a one-time email job for about {count} valid primary addresses, regardless of targeting. It will queue immediately or when starts_at is reached.',
        confirmSend: 'Publish and Send Email',
        continueEditing: 'Continue Editing',
        queuedSuccess: 'Announcement saved and email delivery queued. Check the Email Status column for actual delivery progress.',
        openDetailsFor: 'Open email status details for announcement “{title}”',
        deliveryStatus: 'Delivery Status',
        detailsTitle: 'Announcement Email Status',
        autoRefreshing: 'Refreshes every 5 seconds',
        refreshStatus: 'Refresh Email Status',
        noStatus: 'No email job has been created for this announcement.',
        availableAt: 'Available At',
        startedAt: 'Started At',
        finishedAt: 'Finished At',
        errorSummary: 'Latest Error Summary',
        retryTitle: 'Controlled Retry',
        retryHint: 'Retries failed recipients only. Ambiguous recipients are excluded by default to reduce duplicate delivery risk.',
        retryFailed: 'Retry Failed',
        retryIncludingAmbiguous: 'Retry Failed and Ambiguous',
        retryConfirmTitle: 'Confirm Failed Recipient Retry',
        retryConfirmMessage: 'A new retry job will be created for explicitly failed recipients. Sent and ambiguous recipients are excluded.',
        retryAmbiguousConfirmTitle: 'Confirm Including Ambiguous Recipients',
        retryAmbiguousConfirmMessage: 'Ambiguous means delivery could not be confirmed. Including these recipients may send duplicate email. Continue only after reviewing the impact.',
        retryQueuedSuccess: 'Email retry queued. Continue monitoring the actual delivery status.',
        failedToLoadStatus: 'Failed to load email status. Refresh later; if it persists, inspect the email job service.',
        failedToRetry: 'The email retry could not be queued. Keep this page open and retry; if it persists, review the error summary.',
        metrics: {
          total: 'Total',
          sent: 'Sent',
          failed: 'Failed',
    ...
    promo: {
      ...
      columns: {
        ...
        rechargeBonusMultiplier: 'First Top-up Bonus',
        maxUses: 'Max Uses',
        usedCount: 'Used',
        usage: 'Usage',
        status: 'Status',
      ...
      bonusAmount: 'Bonus Amount ($)',
      rechargeBonusMultiplier: 'First Top-up Bonus Multiplier',
      rechargeBonusMultiplierHint: 'Applies only to the user’s first successful balance top-up; ≥1, e.g. 1.2 credits 20% extra; 1 = no bonus',

                ...
                <div class="overflow-x-auto">
                  <table class="min-w-full text-sm">
                    ...
                    <tbody class="space-y-2">
                      <tr v-for="p in (['anthropic', 'openai', 'gemini', 'antigravity', 'grok', 'adobe', 'cursor', 'opencode'] as const)" :key="p" class="align-top">
                        <td class="pr-4 py-1">
                    ...
                    <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                      ...
                      <div class="overflow-x-auto">
                        <table class="min-w-full text-sm">
                          ...
                          <tbody>
                            <tr v-for="p in (['anthropic', 'openai', 'gemini', 'antigravity', 'grok', 'adobe', 'cursor', 'opencode'] as const)" :key="`${authSource.source}-pq-${p}`" class="align-top">
                              <td class="pr-4 py-1">
                                <span class="font-mono text-xs text-gray-700 dark:text-gray-300">{{ p }}</span>
                              </td>
                              <td class="pr-4 py-1">
        ...
        <div v-show="activeTab === 'general'" class="space-y-6">
          ...
          <div class="card">
            ...
            <div class="space-y-6 p-6">
              ...
              <!-- Notice Bar (scrolling ticker) -->
              <div>
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                >
                  {{ t("admin.settings.site.noticeBar") }}
                </label>
                <textarea
                  v-model="form.notice_bar"
                  rows="3"
                  class="input text-sm"
                  :placeholder="t('admin.settings.site.noticeBarPlaceholder')"
                ></textarea>
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.site.noticeBarHint") }}
                </p>
              </div>
          ...
          <div class="space-y-5 p-6">
            <div class="flex items-center justify-between">
              ...
              <Toggle
                ...
                data-testid="available-channels-enabled"
              />
            </div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="space-y-5 p-6">
            <div class="flex items-center justify-between">
              ...
              <Toggle
                v-model="form.model_square_enabled"
                data-testid="model-square-enabled"
              />
            </div>
          </div>
        </div>
...
> & {
  ...
  // 系统全局平台限额 map；form 内始终归一化为全 8 平台对象（模板非空绑定依赖此不变量）

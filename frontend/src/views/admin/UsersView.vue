    ...
    <TablePageLayout>
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-usage_adobe="{ row }">
            <PlatformCostCell :usage="getPlatformUsage(row.id, 'adobe')" />
          </template>

          <template #cell-usage_cursor="{ row }">
            <PlatformCostCell :usage="getPlatformUsage(row.id, 'cursor')" />
          </template>
...
const allColumns = computed<Column[]>(() => [
  ...
  { key: 'usage_adobe', label: t('admin.users.columns.usageAdobe'), sortable: false },
  { key: 'usage_cursor', label: t('admin.users.columns.usageCursor'), sortable: false },
...
const DEFAULT_HIDDEN_COLUMNS = [
  ...
  'usage_anthropic', 'usage_openai', 'usage_gemini', 'usage_antigravity', 'usage_adobe', 'usage_cursor', 'usage_opencode',
...
const USAGE_COLUMN_KEYS: readonly string[] = ['usage', 'usage_anthropic', 'usage_openai', 'usage_gemini', 'usage_antigravity', 'usage_adobe', 'usage_cursor', 'usage_opencode']

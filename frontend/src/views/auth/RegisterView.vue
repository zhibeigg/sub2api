<template>
  <AuthLayout>
    <div class="space-y-6">
      ...
      <div v-if="!registrationEnabled && settingsLoaded" class="auth-status auth-status--warning">
      ...
      <form v-else @submit.prevent="handleRegister" class="space-y-5">
        ...
        <div v-if="invitationCodeEnabled">
          ...
          <transition name="fade">
            <div v-if="invitationValidation.valid" class="auth-validation-success">
        ...
        <div v-if="promoCodeEnabled">
          ...
          <transition name="fade">
            <div v-if="promoValidation.valid" class="auth-validation-success">

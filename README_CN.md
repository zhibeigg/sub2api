...
- **QQBot 账户绑定** - 为独立腾讯官方 BotGo 服务提供 HMAC 私有 API、邮箱一次性验证链接、OpenID 原子身份绑定、单次余额赠送、兑换流水与完整审计；并发提交、Webhook 重投和解绑后重绑不会重复到账（[集成/API/安全/部署文档](docs/QQBOT_INTEGRATION.md)）

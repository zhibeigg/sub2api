...
func (_q *SubscriptionPlanGroupQuery) QueryPlan() *SubscriptionPlanQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(subscriptionplangroup.Table, subscriptionplangroup.PlanColumn, selector),
			sqlgraph.To(subscriptionplan.Table, subscriptionplan.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, subscriptionplangroup.PlanTable, subscriptionplangroup.PlanColumn),
		)
...
func (_q *SubscriptionPlanGroupQuery) QueryGroup() *GroupQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(subscriptionplangroup.Table, subscriptionplangroup.GroupColumn, selector),
			sqlgraph.To(group.Table, group.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, subscriptionplangroup.GroupTable, subscriptionplangroup.GroupColumn),
		)
		fromU = sqlgraph.SetNeighbors(_q.driver.Dialect(), step)
		return fromU, nil
	}
...
func (_q *SubscriptionPlanGroupQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(subscriptionplangroup.Table, subscriptionplangroup.Columns, nil)
	_spec.From = _q.sql

...
type Group struct {
	...
	// 分组模型级倍率：模型匹配模式 -> 正数倍率；仅影响最终计费倍率，不修改模型价格
	...
	// 分组公开入站协议集合；platform 保留为兼容期旧运行配置
	EndpointProtocols []string `json:"endpoint_protocols,omitempty"`
	// 分组用量归属平台；与 endpoint_protocols 解耦
...
type GroupEdges struct {
	...
	// AccessRestrictedUsers holds the value of the access_restricted_users edge.
	AccessRestrictedUsers []*User `json:"access_restricted_users,omitempty"`
	...
	// AuthorizedSubscriptions holds the value of the authorized_subscriptions edge.
	AuthorizedSubscriptions []*UserSubscription `json:"authorized_subscriptions,omitempty"`
	...
	// UserGroupAccessGroups holds the value of the user_group_access_groups edge.
	UserGroupAccessGroups []*UserGroupAccessGroup `json:"user_group_access_groups,omitempty"`
	...
	// UserSubscriptionGroups holds the value of the user_subscription_groups edge.
	UserSubscriptionGroups []*UserSubscriptionGroup `json:"user_subscription_groups,omitempty"`
...
// AccessRestrictedUsersOrErr returns the AccessRestrictedUsers value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) AccessRestrictedUsersOrErr() ([]*User, error) {
	if e.loadedTypes[7] {
		return e.AccessRestrictedUsers, nil
	}
	return nil, &NotLoadedError{edge: "access_restricted_users"}
}
...
// AuthorizedSubscriptionsOrErr returns the AuthorizedSubscriptions value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) AuthorizedSubscriptionsOrErr() ([]*UserSubscription, error) {
	if e.loadedTypes[9] {
		return e.AuthorizedSubscriptions, nil
	}
	return nil, &NotLoadedError{edge: "authorized_subscriptions"}
}
...
// UserGroupAccessGroupsOrErr returns the UserGroupAccessGroups value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) UserGroupAccessGroupsOrErr() ([]*UserGroupAccessGroup, error) {
	if e.loadedTypes[13] {
		return e.UserGroupAccessGroups, nil
	}
	return nil, &NotLoadedError{edge: "user_group_access_groups"}
}
...
// UserSubscriptionGroupsOrErr returns the UserSubscriptionGroups value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) UserSubscriptionGroupsOrErr() ([]*UserSubscriptionGroup, error) {
	if e.loadedTypes[15] {
		return e.UserSubscriptionGroups, nil
	}
	return nil, &NotLoadedError{edge: "user_subscription_groups"}
}
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case group.FieldModelRateMultipliers, group.FieldEndpointProtocols, group.FieldModelRouting, group.FieldSupportedModelScopes, group.FieldMessagesDispatchModelConfig, group.FieldModelsListConfig:
			values[i] = new([]byte)
		...
		case group.FieldName, group.FieldDescription, group.FieldPeakStart, group.FieldPeakEnd, group.FieldStatus, group.FieldDuplicateOperationID, group.FieldPlatform, group.FieldQuotaPlatform, group.FieldSubscriptionType, group.FieldDefaultMappedModel, group.FieldPoolCapacityAlertMetric:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldEndpointProtocols:
			if value, ok := values[i].(*[]byte); !ok {
				return fmt.Errorf("unexpected type %T for field endpoint_protocols", values[i])
			} else if value != nil && len(*value) > 0 {
				if err := json.Unmarshal(*value, &_m.EndpointProtocols); err != nil {
					return fmt.Errorf("unmarshal field endpoint_protocols: %w", err)
				}
			}
		case group.FieldQuotaPlatform:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field quota_platform", values[i])
			} else if value.Valid {
				_m.QuotaPlatform = value.String
			}
		...
		case group.FieldPoolCapacityAlertEnabled:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field pool_capacity_alert_enabled", values[i])
			} else if value.Valid {
...
// QueryAccessRestrictedUsers queries the "access_restricted_users" edge of the Group entity.
func (_m *Group) QueryAccessRestrictedUsers() *UserQuery {
	return NewGroupClient(_m.config).QueryAccessRestrictedUsers(_m)
}
...
// QueryAuthorizedSubscriptions queries the "authorized_subscriptions" edge of the Group entity.
func (_m *Group) QueryAuthorizedSubscriptions() *UserSubscriptionQuery {
	return NewGroupClient(_m.config).QueryAuthorizedSubscriptions(_m)
}
...
// QueryUserGroupAccessGroups queries the "user_group_access_groups" edge of the Group entity.
func (_m *Group) QueryUserGroupAccessGroups() *UserGroupAccessGroupQuery {
	return NewGroupClient(_m.config).QueryUserGroupAccessGroups(_m)
}
...
// QueryUserSubscriptionGroups queries the "user_subscription_groups" edge of the Group entity.
func (_m *Group) QueryUserSubscriptionGroups() *UserSubscriptionGroupQuery {
	return NewGroupClient(_m.config).QueryUserSubscriptionGroups(_m)
}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("endpoint_protocols=")
	builder.WriteString(fmt.Sprintf("%v", _m.EndpointProtocols))
	builder.WriteString(", ")
	builder.WriteString("quota_platform=")
	builder.WriteString(_m.QuotaPlatform)
	builder.WriteString(", ")

...
func (*PoolCapacityAlertEvent) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case poolcapacityalertevent.FieldRemainingBalanceUsd, poolcapacityalertevent.FieldPoolAuthoritativeBalanceUsd, poolcapacityalertevent.FieldNormalEstimatedBalanceUsd, poolcapacityalertevent.FieldThresholdUsd, poolcapacityalertevent.FieldAvgAccountCost, poolcapacityalertevent.FieldAvgActualCost, poolcapacityalertevent.FieldAccountRemaining, poolcapacityalertevent.FieldAPIKeyRemaining, poolcapacityalertevent.FieldWalletRemaining:
			values[i] = new(sql.NullFloat64)
		case poolcapacityalertevent.FieldID, poolcapacityalertevent.FieldStateID, poolcapacityalertevent.FieldEpisode, poolcapacityalertevent.FieldGroupID, poolcapacityalertevent.FieldGroupGeneration, poolcapacityalertevent.FieldAccountID, poolcapacityalertevent.FieldAPIKeyID, poolcapacityalertevent.FieldUserID, poolcapacityalertevent.FieldBillingType, poolcapacityalertevent.FieldPredictedRequests, poolcapacityalertevent.FieldPoolAccountCount, poolcapacityalertevent.FieldNormalAccountCount, poolcapacityalertevent.FieldSkippedAccountCount, poolcapacityalertevent.FieldUnknownAccountCount, poolcapacityalertevent.FieldStaleAccountCount, poolcapacityalertevent.FieldIncompatibleUnitAccountCount, poolcapacityalertevent.FieldThresholdRequests, poolcapacityalertevent.FieldAccountRequests, poolcapacityalertevent.FieldAPIKeyRequests, poolcapacityalertevent.FieldWalletRequests, poolcapacityalertevent.FieldSampleCount:
			values[i] = new(sql.NullInt64)
		case poolcapacityalertevent.FieldScopeType, poolcapacityalertevent.FieldGroupName, poolcapacityalertevent.FieldAccountName, poolcapacityalertevent.FieldAPIKeyName, poolcapacityalertevent.FieldUserEmail, poolcapacityalertevent.FieldAlertMetric, poolcapacityalertevent.FieldBottleneck, poolcapacityalertevent.FieldQqbotAppID:
...
func (_m *PoolCapacityAlertEvent) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case poolcapacityalertevent.FieldScopeType:
		...
		case poolcapacityalertevent.FieldPoolAuthoritativeBalanceUsd:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
		...
		case poolcapacityalertevent.FieldNormalEstimatedBalanceUsd:
			if value, ok := values[i].(*sql.NullFloat64); !ok {

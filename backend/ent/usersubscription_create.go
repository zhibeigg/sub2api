...
func (_c *UserSubscriptionCreate) SetSourcePlanID(v int64) *UserSubscriptionCreate {
	_c.mutation.SetSourcePlanID(v)
	return _c
}

// SetNillableSourcePlanID sets the "source_plan_id" field if the given value is not nil.
func (_c *UserSubscriptionCreate) SetNillableSourcePlanID(v *int64) *UserSubscriptionCreate {
	if v != nil {
...
// SetQuotaSnapshotted sets the "quota_snapshotted" field.
func (_c *UserSubscriptionCreate) SetQuotaSnapshotted(v bool) *UserSubscriptionCreate {
	_c.mutation.SetQuotaSnapshotted(v)
	return _c
}

// SetNillableQuotaSnapshotted sets the "quota_snapshotted" field if the given value is not nil.
func (_c *UserSubscriptionCreate) SetNillableQuotaSnapshotted(v *bool) *UserSubscriptionCreate {
	if v != nil {
		_c.SetQuotaSnapshotted(*v)
	}
	return _c
}
...
func (_c *UserSubscriptionCreate) SetConcurrencyLimit(v int) *UserSubscriptionCreate {
...
func (_c *UserSubscriptionCreate) SetNillableConcurrencyLimit(v *int) *UserSubscriptionCreate {
	if v != nil {
...
// SetSourcePlan sets the "source_plan" edge to the SubscriptionPlan entity.
func (_c *UserSubscriptionCreate) SetSourcePlan(v *SubscriptionPlan) *UserSubscriptionCreate {
	return _c.SetSourcePlanID(v.ID)
}

// AddAuthorizedGroupIDs adds the "authorized_groups" edge to the Group entity by IDs.
func (_c *UserSubscriptionCreate) AddAuthorizedGroupIDs(ids ...int64) *UserSubscriptionCreate {
	_c.mutation.AddAuthorizedGroupIDs(ids...)
	return _c
}

// AddAuthorizedGroups adds the "authorized_groups" edges to the Group entity.
func (_c *UserSubscriptionCreate) AddAuthorizedGroups(v ...*Group) *UserSubscriptionCreate {
...
func (_c *UserSubscriptionCreate) defaults() error {
	...
	if _, ok := _c.mutation.QuotaSnapshotted(); !ok {
		v := usersubscription.DefaultQuotaSnapshotted
		_c.mutation.SetQuotaSnapshotted(v)
	}
...
func (_c *UserSubscriptionCreate) check() error {
	...
	if _, ok := _c.mutation.QuotaSnapshotted(); !ok {
		return &ValidationError{Name: "quota_snapshotted", err: errors.New(`ent: missing required field "UserSubscription.quota_snapshotted"`)}
	}
...
func (_c *UserSubscriptionCreate) createSpec() (*UserSubscription, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.QuotaSnapshotted(); ok {
		_spec.SetField(usersubscription.FieldQuotaSnapshotted, field.TypeBool, value)
		_node.QuotaSnapshotted = value
	}
	...
	if value, ok := _c.mutation.ConcurrencyLimit(); ok {
		_spec.SetField(usersubscription.FieldConcurrencyLimit, field.TypeInt, value)
	...
	if nodes := _c.mutation.SourcePlanIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   usersubscription.SourcePlanTable,
			Columns: []string{usersubscription.SourcePlanColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := _c.mutation.AuthorizedGroupsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   usersubscription.AuthorizedGroupsTable,
			Columns: usersubscription.AuthorizedGroupsPrimaryKey,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(group.FieldID, field.TypeInt64),
			},
		...
		createE := &UserSubscriptionGroupCreate{config: _c.config, mutation: newUserSubscriptionGroupMutation(_c.config, OpCreate)}
		createE.defaults()
...
// SetSourcePlanID sets the "source_plan_id" field.
func (u *UserSubscriptionUpsert) SetSourcePlanID(v int64) *UserSubscriptionUpsert {
	u.Set(usersubscription.FieldSourcePlanID, v)
	return u
}

// UpdateSourcePlanID sets the "source_plan_id" field to the value that was provided on create.
func (u *UserSubscriptionUpsert) UpdateSourcePlanID() *UserSubscriptionUpsert {
	u.SetExcluded(usersubscription.FieldSourcePlanID)
	return u
}

// ClearSourcePlanID clears the value of the "source_plan_id" field.
func (u *UserSubscriptionUpsert) ClearSourcePlanID() *UserSubscriptionUpsert {
	u.SetNull(usersubscription.FieldSourcePlanID)
	return u
}

// SetQuotaSnapshotted sets the "quota_snapshotted" field.
func (u *UserSubscriptionUpsert) SetQuotaSnapshotted(v bool) *UserSubscriptionUpsert {
	u.Set(usersubscription.FieldQuotaSnapshotted, v)
	return u
}

// UpdateQuotaSnapshotted sets the "quota_snapshotted" field to the value that was provided on create.
func (u *UserSubscriptionUpsert) UpdateQuotaSnapshotted() *UserSubscriptionUpsert {
	u.SetExcluded(usersubscription.FieldQuotaSnapshotted)
	return u
}
...
// SetConcurrencyLimit sets the "concurrency_limit" field.
func (u *UserSubscriptionUpsert) SetConcurrencyLimit(v int) *UserSubscriptionUpsert {
	u.Set(usersubscription.FieldConcurrencyLimit, v)
	return u
}

// UpdateConcurrencyLimit sets the "concurrency_limit" field to the value that was provided on create.
func (u *UserSubscriptionUpsert) UpdateConcurrencyLimit() *UserSubscriptionUpsert {
	u.SetExcluded(usersubscription.FieldConcurrencyLimit)
	return u
}

// AddConcurrencyLimit adds v to the "concurrency_limit" field.
func (u *UserSubscriptionUpsert) AddConcurrencyLimit(v int) *UserSubscriptionUpsert {
	u.Add(usersubscription.FieldConcurrencyLimit, v)
	return u
}

// ClearConcurrencyLimit clears the value of the "concurrency_limit" field.
func (u *UserSubscriptionUpsert) ClearConcurrencyLimit() *UserSubscriptionUpsert {
	u.SetNull(usersubscription.FieldConcurrencyLimit)
	return u
}
...
// SetSourcePlanID sets the "source_plan_id" field.
func (u *UserSubscriptionUpsertOne) SetSourcePlanID(v int64) *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.SetSourcePlanID(v)
	})
}
...
// UpdateSourcePlanID sets the "source_plan_id" field to the value that was provided on create.
func (u *UserSubscriptionUpsertOne) UpdateSourcePlanID() *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
...
// ClearSourcePlanID clears the value of the "source_plan_id" field.
func (u *UserSubscriptionUpsertOne) ClearSourcePlanID() *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.ClearSourcePlanID()
	})
}
...
// SetQuotaSnapshotted sets the "quota_snapshotted" field.
func (u *UserSubscriptionUpsertOne) SetQuotaSnapshotted(v bool) *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.SetQuotaSnapshotted(v)
	})
}

// UpdateQuotaSnapshotted sets the "quota_snapshotted" field to the value that was provided on create.
func (u *UserSubscriptionUpsertOne) UpdateQuotaSnapshotted() *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.UpdateQuotaSnapshotted()
	})
}
...
// SetConcurrencyLimit sets the "concurrency_limit" field.
func (u *UserSubscriptionUpsertOne) SetConcurrencyLimit(v int) *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
...
// AddConcurrencyLimit adds v to the "concurrency_limit" field.
func (u *UserSubscriptionUpsertOne) AddConcurrencyLimit(v int) *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
...
// UpdateConcurrencyLimit sets the "concurrency_limit" field to the value that was provided on create.
func (u *UserSubscriptionUpsertOne) UpdateConcurrencyLimit() *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
...
// ClearConcurrencyLimit clears the value of the "concurrency_limit" field.
func (u *UserSubscriptionUpsertOne) ClearConcurrencyLimit() *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
...
// SetSourcePlanID sets the "source_plan_id" field.
func (u *UserSubscriptionUpsertBulk) SetSourcePlanID(v int64) *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.SetSourcePlanID(v)
	})
}
...
// UpdateSourcePlanID sets the "source_plan_id" field to the value that was provided on create.
func (u *UserSubscriptionUpsertBulk) UpdateSourcePlanID() *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.UpdateSourcePlanID()
	})
}
...
// ClearSourcePlanID clears the value of the "source_plan_id" field.
func (u *UserSubscriptionUpsertBulk) ClearSourcePlanID() *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.ClearSourcePlanID()
	})
}
...
// SetQuotaSnapshotted sets the "quota_snapshotted" field.
func (u *UserSubscriptionUpsertBulk) SetQuotaSnapshotted(v bool) *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.SetQuotaSnapshotted(v)
	})
}
...
// UpdateQuotaSnapshotted sets the "quota_snapshotted" field to the value that was provided on create.
func (u *UserSubscriptionUpsertBulk) UpdateQuotaSnapshotted() *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.UpdateQuotaSnapshotted()
	})
}
...
// SetConcurrencyLimit sets the "concurrency_limit" field.
func (u *UserSubscriptionUpsertBulk) SetConcurrencyLimit(v int) *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.SetConcurrencyLimit(v)
	})
}
...
// AddConcurrencyLimit adds v to the "concurrency_limit" field.
func (u *UserSubscriptionUpsertBulk) AddConcurrencyLimit(v int) *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.AddConcurrencyLimit(v)
	})
}
...
// UpdateConcurrencyLimit sets the "concurrency_limit" field to the value that was provided on create.
func (u *UserSubscriptionUpsertBulk) UpdateConcurrencyLimit() *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.UpdateConcurrencyLimit()
	})
}
...
// ClearConcurrencyLimit clears the value of the "concurrency_limit" field.
func (u *UserSubscriptionUpsertBulk) ClearConcurrencyLimit() *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.ClearConcurrencyLimit()
	})
}

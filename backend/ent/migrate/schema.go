...
var (
	...
	AccountGroupsColumns = []*schema.Column{
		{Name: "priority", Type: field.TypeInt, Default: 50},
		{Name: "endpoint_compatibility_enabled", Type: field.TypeBool, Default: false},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "endpoint_protocols", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "quota_platform", Type: field.TypeString, Size: 50, Default: "anthropic"},
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "recharge_base_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "recharge_bonus_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "first_recharge_bonus_applied", Type: field.TypeBool, Default: false},
	...
	PoolCapacityAlertEventsColumns = []*schema.Column{
		...
		{Name: "scope_type", Type: field.TypeString, Size: 16, Default: "context"},
		{Name: "account_id", Type: field.TypeInt64, Nullable: true},
		{Name: "api_key_id", Type: field.TypeInt64, Nullable: true},
		...
		{Name: "pool_authoritative_balance_usd", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "numeric(30,12)"}},
		{Name: "normal_estimated_balance_usd", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "numeric(30,12)"}},
		{Name: "pool_account_count", Type: field.TypeInt, Default: 0},
		{Name: "normal_account_count", Type: field.TypeInt, Default: 0},
		{Name: "skipped_account_count", Type: field.TypeInt, Default: 0},
		{Name: "unknown_account_count", Type: field.TypeInt, Default: 0},
		{Name: "stale_account_count", Type: field.TypeInt, Default: 0},
		{Name: "incompatible_unit_account_count", Type: field.TypeInt, Default: 0},
	...
	PoolCapacityAlertEventsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{PoolCapacityAlertEventsColumns[3], PoolCapacityAlertEventsColumns[38]},
			},
			{
				Name:    "poolcapacityalertevent_created_at",
				Unique:  false,
				Columns: []*schema.Column{PoolCapacityAlertEventsColumns[38]},
			},
		},
	}
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{PoolCapacityAlertStatesColumns[1], PoolCapacityAlertStatesColumns[2], PoolCapacityAlertStatesColumns[4], PoolCapacityAlertStatesColumns[5], PoolCapacityAlertStatesColumns[6], PoolCapacityAlertStatesColumns[7]},
				Annotation: &entsql.IndexAnnotation{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{PoolCapacityAlertStatesColumns[8], PoolCapacityAlertStatesColumns[33]},
			},
		},
	}
	...
	SubscriptionPlanGroupsTable = &schema.Table{
		...
		PrimaryKey: []*schema.Column{SubscriptionPlanGroupsColumns[2], SubscriptionPlanGroupsColumns[3]},
		ForeignKeys: []*schema.ForeignKey{
			{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "subscriptionplangroup_plan_id_priority",
				Unique:  false,
				Columns: []*schema.Column{SubscriptionPlanGroupsColumns[2], SubscriptionPlanGroupsColumns[0]},
			},
		},
	}
	...
	UserSubscriptionsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "quota_snapshotted", Type: field.TypeBool, Default: false},
		{Name: "daily_limit_usd", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "weekly_limit_usd", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "monthly_limit_usd", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "concurrency_limit", Type: field.TypeInt, Nullable: true},
		...
		{Name: "notes", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "group_id", Type: field.TypeInt64},
		{Name: "source_plan_id", Type: field.TypeInt64, Nullable: true},
		{Name: "user_id", Type: field.TypeInt64},
	...
	UserSubscriptionsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UserSubscriptionsColumns[22], UserSubscriptionsColumns[11], UserSubscriptionsColumns[10]},
			},
			{
			...
			{
				Name:    "usersubscription_source_plan_id",
				Unique:  false,
				Columns: []*schema.Column{UserSubscriptionsColumns[21]},
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UserSubscriptionsColumns[22], UserSubscriptionsColumns[20]},
			},
			{
	...
	UserSubscriptionGroupsTable = &schema.Table{
		...
		PrimaryKey: []*schema.Column{UserSubscriptionGroupsColumns[4], UserSubscriptionGroupsColumns[5]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "user_subscription_groups_user_subscriptions_subscription",
				Columns:    []*schema.Column{UserSubscriptionGroupsColumns[4]},
				RefColumns: []*schema.Column{UserSubscriptionsColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
				Symbol:     "user_subscription_groups_groups_group",
				Columns:    []*schema.Column{UserSubscriptionGroupsColumns[5]},
				RefColumns: []*schema.Column{GroupsColumns[0]},
				OnDelete:   schema.NoAction,
			},
		},
		Indexes: []*schema.Index{
			...
			{
				Name:    "usersubscriptiongroup_user_id_group_id",
				Unique:  true,
				Columns: []*schema.Column{UserSubscriptionGroupsColumns[0], UserSubscriptionGroupsColumns[5]},
				Annotation: &entsql.IndexAnnotation{
					Where: "enabled = true",
				},
			},
			{
				Name:    "usersubscriptiongroup_subscription_id_enabled",
				Unique:  false,
				Columns: []*schema.Column{UserSubscriptionGroupsColumns[4], UserSubscriptionGroupsColumns[1]},
			},
		},
	}
...
func init() {
	...
	UserSubscriptionGroupsTable.ForeignKeys[0].RefTable = UserSubscriptionsTable
	UserSubscriptionGroupsTable.ForeignKeys[1].RefTable = GroupsTable

...
type AdminService interface {
	...
	AdminUpdateAPIKeyGroupID(ctx context.Context, keyID int64, groupID *int64, groupBindings *[]APIKeyGroupBindingInput) (*AdminUpdateAPIKeyGroupIDResult, error)

...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeyChatwootEnabled:                           strconv.FormatBool(s.cfg.Chatwoot.Enabled),
		SettingKeyChatwootBaseURL:                           s.cfg.Chatwoot.BaseURL,
		SettingKeyChatwootWebsiteToken:                      s.cfg.Chatwoot.WebsiteToken,
		SettingKeyChatwootIdentityValidationSecret:          s.cfg.Chatwoot.IdentityValidationSecret,
		...
		// Available channels and model square features (default disabled; opt-in)
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	result := &SystemSettings{
		...
		ChatwootIdentityValidationSecret:           chatwoot.IdentityValidationSecret,
		ChatwootIdentityValidationSecretConfigured: chatwoot.IdentityValidationSecret != "",
		...
		NoticeBar:                                  settings[SettingKeyNoticeBar],
	...
	// Available channels and model square features (default: disabled; strict true)

...
type UserSubscriptionRepository interface {
	...
	ActivateWindows(ctx context.Context, id int64, starts SubscriptionWindowStarts) error
	ResetUsageWindows(ctx context.Context, id int64, resetDaily, resetWeekly, resetMonthly bool, starts SubscriptionWindowStarts) error

...
func (s *defaultOpenAIAccountScheduler) selectByLoadBalance(
	...
	for i := range accounts {
		...
		if !openAIPlatformAllowed(account, req.Platform) {
...
func (s *defaultOpenAIAccountScheduler) isAccountRequestCompatibleReason(ctx context.Context, account *Account, req OpenAIAccountScheduleRequest) (bool, string) {
	...
	if !openAIRequestDescriptorAllowedForContext(ctx, account, req.Platform, descriptor) {
		return false, "endpoint_incompatible"
	}
	...
	if !accountSupportsOpenAICapabilities(account, req.RequiredCapability, descriptor.OpenAIImageCapability, requestedModel, descriptor.EndpointPath) {

...
func TestLoadHTTPIngressSafetyDefaults(t *testing.T) {
	...
	require.Equal(t, "zh", cfg.Gateway.ModelErrorDefaultLocale)
...
func TestLoadPoolCapacityAlertConfigAndBounds(t *testing.T) {
	...
	t.Setenv("POOL_CAPACITY_ALERT_GROUP_BALANCE_CONCURRENCY", "99")
	t.Setenv("POOL_CAPACITY_ALERT_GROUP_BALANCE_TIMEOUT_SECONDS", "999")
	...
	require.Equal(t, 16, cfg.PoolCapacityAlert.GroupBalanceConcurrency)
	require.Equal(t, 300, cfg.PoolCapacityAlert.GroupBalanceTimeoutSeconds)

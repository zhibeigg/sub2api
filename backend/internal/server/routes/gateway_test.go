...
func newGatewayRoutesTestRouterWithConfig(cfg *config.Config, platform ...string) *gin.Engine {
	...
	groupID := int64(1)
	return newGatewayRoutesTestRouterWithAPIKeyAndConfig(&service.APIKey{
		GroupID: &groupID,
...
func newGatewayRoutesTestRouterWithAPIKey(apiKey *service.APIKey) *gin.Engine {
	return newGatewayRoutesTestRouterWithAPIKeyAndConfig(apiKey, &config.Config{})
}

func newGatewayRoutesTestRouterWithAPIKeyAndConfig(apiKey *service.APIKey, cfg *config.Config) *gin.Engine {

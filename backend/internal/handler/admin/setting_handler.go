...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		ChatwootIdentityValidationSecretConfigured:             settings.ChatwootIdentityValidationSecretConfigured,
		...
		PaymentVisibleMethodQQPaySource:                        settings.PaymentVisibleMethodQQPaySource,
		PaymentVisibleMethodAlipayEnabled:                      settings.PaymentVisibleMethodAlipayEnabled,
		PaymentVisibleMethodWxpayEnabled:                       settings.PaymentVisibleMethodWxpayEnabled,
		PaymentVisibleMethodQQPayEnabled:                       settings.PaymentVisibleMethodQQPayEnabled,

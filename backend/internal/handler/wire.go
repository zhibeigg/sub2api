...
func ProvideAdminHandlers(
	...
	cursorDashboardAuthHandler *admin.CursorDashboardAuthHandler,
	...
	return &AdminHandlers{
		...
		CursorDashboardAuth:    cursorDashboardAuthHandler,
		Proxy:                  proxyHandler,
...
func ProvideAuthHandler(
	...
	h.SetWeChatPaymentOAuthService(wechatPaymentOAuthService)
	return h
}
...
func ProvideGatewayHandler(
	...
	h := NewGatewayHandler(gatewayService, openAIGatewayService, geminiCompatService, antigravityGatewayService,
		cursorGatewayService, kiroGatewayService, userService, concurrencyService, billingCacheService, usageService, apiKeyService, usageRecordWorkerPool,
...
func ProvideOpenAIGatewayHandler(
	...
	h := NewOpenAIGatewayHandler(gatewayService, concurrencyService, billingCacheService, apiKeyService,
		subscriptionService, imageUploadTempService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, cfg)
	h.securityAuditCoordinator = coordinator
	return h
}
...
func ProvideHandlers(
	...
	adobeMediaHandler *AdobeMediaHandler,
...
var ProviderSet = wire.NewSet(
	...
	admin.NewCursorDashboardAuthHandler,
